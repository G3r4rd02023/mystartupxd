...
namespace mystartupxd.Migrations
{
    ...
    [Migration("20210923040149_OrderEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.OrderDetailTemp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("mystartupxd.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.Order", b =>
                {
                    b.HasOne("mystartupxd.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.OrderDetail", b =>
                {
                    b.HasOne("mystartupxd.Data.Entities.Order", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("mystartupxd.Data.Entities.User", b =>
                {
                    b.HasOne("mystartupxd.Data.Entities.City", "City")
                        .WithMany()
